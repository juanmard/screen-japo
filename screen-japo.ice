  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "4783c2ef-d25b-4550-92c2-a5eba3de2c49",
          "type": "basic.code",
          "data": {
            "code": "\nwire [19:0] x_centered;\nwire [19:0] y_centered;\nreg  [19:0] size = 20'd22500;\nreg  [32:0] counter = 0;\n\nassign x_centered = x_px - 20'd320;\nassign y_centered = y_px - 20'd240;\n\nassign color = (\n    x_centered * x_centered +\n    y_centered * y_centered < size ?\n        3'b100 :\n        3'b111\n);\n\nalways @(posedge px_clk)\nbegin\n    counter <= counter + 1;\nend\n    \nalways @(posedge counter[8])\nbegin\n    if (inc_size) size <= size + 1;\n    if (dec_size) size <= size - 1;\nend",
            "params": [],
            "ports": {
              "in": [
                {
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "4783c2ef-d25b-4550-92c2-a5eba3de2c49",
            "port": "x_px"
          },
          "size": 10
        },
